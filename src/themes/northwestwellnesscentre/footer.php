        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left">
                    <p class="small mb-50 mb-md-0">&copy; <?php echo Date('Y') . ' ' . get_bloginfo('name'); ?>  |&nbsp;<a href="<?php echo esc_url(home_url('/terms-and-conditions')); ?>" class="text-white">Terms & Conditions</a></p>
                </div>
